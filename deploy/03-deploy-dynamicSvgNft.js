...
ethUdPriceAddress = ethUsdAggregator.address
    ...
    const highSvg = fs.readFileSync("./images/dynamicNft/cloud-bolt.svg", { encoding: "utf8" })
    const lowSvg = fs.readFileSync("./images/dynamicNft/cloud-rain-alt.svg", { encoding: "utf8" })
